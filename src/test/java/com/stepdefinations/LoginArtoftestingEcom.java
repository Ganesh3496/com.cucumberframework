...
@Before
	...
	{
		 // Assume driver is initialized and login page is open
	    WebElement usernameInput = driver.findElement(By.id("username")); // Replace with your actual locator
	    WebElement passwordInput = driver.findElement(By.id("password"));
	    WebElement loginButton = driver.findElement(By.id("loginBtn"));

	    usernameInput.sendKeys("user1");  // Replace with dynamic values from DataTable if needed
